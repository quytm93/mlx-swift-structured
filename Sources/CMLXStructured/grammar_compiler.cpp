...
extern "C" void *
compile_ebnf_grammar(void *tokenizer_info, const char *ebnf_utf8, size_t ebnf_len) {
    try {
...
extern "C" void *
compile_regex_grammar(void *tokenizer_info, const char *regex_utf8, size_t regex_len) {
    try {
